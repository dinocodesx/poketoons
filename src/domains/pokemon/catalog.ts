import catalogData from "../../shared/data/pokemon-catalog.json";
import bucketData from "../../shared/data/rarity-buckets.json";
import { validatePokemonData } from "./validation";
import type { PokemonCatalogEntry, RarityBucket } from "./types";
